...
.factory('DaoFact', function() {
    ...
    ofertas.insertAll([
        ...
        { id: 3, descricao: "Extrato de Tomante Pomarola UN 350g", valor: 1.99, validade: new Date(), anunciante: anunciantes.getById(1), categoriaId: 3 },
        ...
        { id: 7, descricao: "Carne Picanha Friboi KG", valor: 23.49, validade: new Date(), anunciante: anunciantes.getById(1), imagem: './img/carne friboi.png', categoriaId: 1 },
